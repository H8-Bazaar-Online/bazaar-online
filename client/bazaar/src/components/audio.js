...
const Player = ({ url }) => {
  ...
  return (
    <div style={{
      ...
      </svg></i> : <i className="bi bi-volume-mute"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-volume-mute" viewBox="0 0 16 16">
