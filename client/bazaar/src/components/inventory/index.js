...
function Inventory() {
  ...
  return (
    <div className="Inventory" style={{
      ...
      <button type="button" className="nes-btn" data-bs-toggle="modal" data-bs-target="#exampleModal"><i className="bi bi-cart"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
